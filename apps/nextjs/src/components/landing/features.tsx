        ...
        <div className="px-m">
          ...
          <div className="mx-auto mt-l grid max-w-6xl grid-cols-1 gap-xxs md:grid-cols-4">
            <div className="rounded-[5px] bg-secondary px-xs py-xs">
              ...
              <h6 className="text-h6 font-[600] text-white">Cloud Freedom</h6>
              <p className="pt-3 text-[14px] text-gray-400">
                Seamlessly connect to your preferred cloud provider or host it
            ...
            <div className="rounded-[5px] bg-secondary px-xs py-xs">
              ...
              <h6 className="text-h6 font-[600] text-white">
                Effortless Video Storage
              </h6>
              <p className="pt-3 text-[14px] text-gray-400">
                Store your captivating recordings securely on the cloud or your
            ...
            <div className="rounded-[5px] bg-secondary px-xs py-xs">
              ...
              <h6 className="text-h6 font-[600] text-white">Powered with AI</h6>
              <p className="pt-3 text-[14px] text-gray-400">
                Let our AI effortlessly craft engaging titles and subtitles for
                your videos.
              </p>
            </div>
            <div className="rounded-[5px] bg-secondary px-xs py-xs">
              ...
              <p className="pt-3 text-[14px] text-gray-400">
                Choose between popular cloud providers, self-hosting, or our
                streamlined cloud service.
              </p>
            </div>
          </div>
        </div>
