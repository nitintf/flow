...
export const Pricing = () => {
  return (
    <section id="pricing" className="relative z-10 overflow-hidden bg-white pb-12 pt-20 dark:bg-dark lg:pb-[90px] lg:pt-[120px]">
      <div className="container mx-auto">
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4">
            <div className="mx-auto mb-[60px] text-center">
              <h2 className="text-h3 font-[700] pb-xxs">Start your journey today</h2>
    ...
    <>
      <div className="w-full md:w-1/2 lg:w-1/3">
        <div className={cn("relative z-10 mb-10 rounded-[10px] border shadow-pricing p-xs border-gray-200 bg-gray-50", {
          ...
          <span className={cn("block text-lg font-semibold text-primary", {
            "text-white": active
          })}>
            {type} {active && <Badge className="ml-xxs" variant={'secondary'}>Most Popular</Badge>}
          </span>
          <h2 className={cn("text-[40px] font-bold text-dark dark:text-white", {
            "text-white": active
          })}>
            {price}
          ...
          <p className={cn("mb-4 border-b border-stroke border-gray-300 pb-4 text-base text-gray-500 mt-2", {
            'border-zinc-600 text-gray-400' : active
          })}>
            {description}
          </p>
