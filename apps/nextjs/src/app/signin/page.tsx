...
export default async function Page() {
  ...
  return (
    <div className="flex h-screen items-center justify-center px-m">
      <div className="mx-auto max-w-lg rounded-xl bg-secondary py-l">
        <div className="flex h-full w-full flex-col items-center justify-center px-m">
          <div>
            <h1 className="header-text text-h2 font-[700] leading-[1.7]">
              Sign in to Flow
            </h1>
            <h1 className="text-h3 font-[700] leading-[1.2] text-white">
            ...
            >
              <Button
                size={"lg"}
                className="mt-s flex w-full items-center justify-start gap-5"
              >
                <svg
                  width={20}
                  height={20}
